...
def solverBEN(id, mh, maxIter, pop, function, lb, ub, dim, extra_params=None):
    ...
    lines_results = ["iter,nfe,best_fitness,mean_fitness,std_fitness,time,XPL,XPT,DIV,GAP,RDP,ENT,Divj_mean,Divj_min,Divj_max\n"]
    ...
    try:
        ...
        for iter in range(1, maxIter + 1):  # ← NO cambiar esto
            ...
            lines_divj.append(f"{iter}," + ",".join([f"{v:.6f}" for v in divj_vec]) + "\n")
