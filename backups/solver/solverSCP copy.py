...
def solverSCP(id, mh, maxIter, pop, instances, DS, repairType, param):
    ...
    fitness, best, bestFitness, pBest, pBestScore = evaluate_population(mh, population, fitness, instance, pBest, pBestScore, repairType)
    ...
    def fo(x, i):
        x = b.aplicarBinarizacion(x, DS[0], DS[1], best, matrixBin[i])
