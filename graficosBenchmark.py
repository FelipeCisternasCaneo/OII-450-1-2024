...
for funcion in funciones:
    ...
    if funcion == 'F8':
        ax.contourf(X1, X2, Z, zdir='z', offset=-1000, cmap='viridis', alpha=0.7)
    elif funcion == 'F16':
        ax.contourf(X1, X2, Z, zdir='z', offset=-2, cmap='viridis', alpha=0.7)
    elif funcion == 'F19':
        ax.contourf(X1, X2, Z, zdir='z', offset=-0.12, cmap='viridis', alpha=0.7)  
    elif funcion == 'F20':
        ax.contourf(X1, X2, Z, zdir='z', offset=-0.12, cmap='viridis', alpha=0.7)  
    elif funcion == 'F21':
        ax.contourf(X1, X2, Z, zdir='z', offset=-0.5, cmap='viridis', alpha=0.7)
    elif funcion == 'F22' or funcion == 'F23':
        ax.contourf(X1, X2, Z, zdir='z', offset=-0.6, cmap='viridis', alpha=0.7)
    else:
        ax.contourf(X1, X2, Z, zdir='z', offset=0, cmap='viridis', alpha=0.7)
    ...
    if funcion == 'F8':
        ax.set_zlim(-1000, np.max(Z))  # Ajustar el límite inferior del eje Z para que la proyección se vea bien
    elif funcion == 'F16':
        ax.set_zlim(-2, np.max(Z))  # Ajustar el límite inferior del eje Z para que la proyección se vea bien
    elif funcion == 'F19':
        ax.set_zlim(-0.12, 0)  # Ajustar el límite inferior del eje Z para que la proyección se vea bien    
    elif funcion == 'F20':
        ax.set_zlim(-0.12, 0)  # Ajustar el límite inferior del eje Z para que la proyección se vea bien    
    elif funcion == 'F21':
        ax.set_zlim(-0.5, 0)  # Ajustar el límite inferior del eje Z para que la proyección se vea bien 
    elif funcion == 'F22' or funcion == 'F23':
        ax.set_zlim(-0.6, 0)  # Ajustar el límite inferior del eje Z para que la proyección se vea bien 
    else:
        ax.set_zlim(0, np.max(Z))  # Ajustar el límite inferior del eje Z para que la proyección se vea bien
