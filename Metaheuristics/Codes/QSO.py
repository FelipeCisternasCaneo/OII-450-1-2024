...
def iterarQSO(maxIter, iter, dim, population, bestSolution, lb, ub):
    ...
    for i in range(len(population)):
        ...
        drought = np.abs(population[i] - bestSolution)  # Parámetro de sequía
        new_position = population[i] + r1 * (bestSolution - drought) + r2 * (T * H - N)
