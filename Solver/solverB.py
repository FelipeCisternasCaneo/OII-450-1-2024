...
from Metaheuristics.imports import iterarPO, iterarWOM
...
def solverB(id, mh, maxIter, pop, function, lb, ub, dim):
    ...
    for iter in range(0, maxIter):
        ...
        if mh == 'EHO':
            population = iterarEHO(population, fitness, lb, ub, dim, fo, iter, maxIter)
        ...
        if mh == "LOA":
            population, posibles_mejoras = iterarLOA(maxIter, population, best.tolist(), lb, ub, iter, dim, fitness.tolist(), function)
