...
def solverUSCP(id, mh, maxIter, pop, instances, DS, repairType, param):
    ...
    print("------------------------------------------------------------------------------------------------------")
    print(f"USCP {instances} - {DS} - {instance.getBlockSizes()} - best fitness inicial: {str(bestFitness)}")
    print("------------------------------------------------------------------------------------------------------")
    print("iteracion: " +
            str(0) +
    ...
    for iter in range(0, maxIter):
        ...
        if mh == 'EHO':
            population = iterarEHO(maxIter, iter, instance.getColumns(), population.tolist(), best.tolist(), 0, 1, fitness)
